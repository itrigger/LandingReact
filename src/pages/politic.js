  ...
  return (
    <>
      <Helmet>
        <meta charSet="utf-8" />
        <title>
          Политика конфиденциальности | Вагон Трейд - Покупка и продажа вагонов.
        ...
        <div className="header-bg hbg1">
          ...
          <div className="row bl-light br-light middle-border-12-light middle-border-12-over-bg line2">
            <div className="col-8 xs-col-4">
              <h1>
                <span className="italic">Персональные</span> данные
              </h1>
            </div>
          ...
          <div className="col-12 xs-col-4">
            <div className="layout bl br middle-border-12">
              <p>
                ...
                информации, которую сайт <strong>Вагон Трейд</strong>, (далее –
                Вагон Трейд) расположенный на доменном имени{" "}
                <strong>vagontrade.ru</strong> (а также его субдоменах), может
                получить о Пользователе во время использования сайта
                vagontrade.ru (а также его субдоменов), его программ и его
                продуктов.
              </p>
              ...
              <p>
                ...
                <strong>Вагон Трейд</strong>, которые организуют и (или)
              ...
              <p>
                1.1.5. «Сайт <strong> Вагон Трейд</strong>» - это совокупность
                связанных между собой веб-страниц, размещенных в сети Интернет
                по уникальному адресу (URL): <strong>vagontrade.ru</strong>, а
              ...
              <p>
                ...
                Вагон Трейд, а также другие временные страницы, внизу который
                указана контактная информация Администрации
              </p>

              <p>
                1.1.5. «Пользователь сайта <strong>Вагон Трейд</strong> » (далее
                Пользователь) – лицо, имеющее доступ к сайту{" "}
                <strong>Вагон Трейд</strong>, посредством сети Интернет и
                использующее информацию, материалы и продукты сайта{" "}
                <strong>Вагон Трейд</strong>.
              </p>
              ...
              <p>
                ...
                сети, через который Пользователь получает доступ на Вагон Трейд.
              </p>

              <h2>2. Общие положения</h2>
              <p>
                2.1. Использование сайта Вагон Трейд Пользователем означает
              ...
              <p>
                ...
                Пользователь должен прекратить использование сайта Вагон Трейд .
              </p>

              <p>
                2.3. Настоящая Политика конфиденциальности применяется к сайту
                Вагон Трейд. Вагон Трейд не контролирует и не несет
                ответственность за сайты третьих лиц, на которые Пользователь
                может перейти по ссылкам, доступным на сайте Вагон Трейд.
              </p>
              ...
              <p>
                ...
                регистрации на сайте Вагон Трейд или при подписке на
              ...
              <p>
                ...
                Пользователем путём заполнения форм на сайте Вагон Трейд и
              ...
              <p>
                3.3. Вагон Трейд защищает Данные, которые автоматически
              ...
              <p>
                3.3.2. Вагон Трейд осуществляет сбор статистики об IP-адресах
              ...
              <p>
                ...
                (история посещения, используемые браузеры, операционные системы
                и т.д.) подлежит надежному хранению и нераспространению, за
                исключением случаев, предусмотренных в п.п. 5.2. настоящей
              ...
              <p>
                ...
                Вагон Трейд, если Пользователь дал согласие на создание учетной
                записи.
                <br />
              ...
              <p>
                ...
                персональных данных, необходимых для использования сайта Вагон
                Трейд, и давать согласие на их обработку.
              </p>
              ...
              <p>
                ...
                этого достаточно уведомить Администрацию по указаному E-mail
                адресу.
              </p>
              ...
              <p>
                ...
                с законодательством Российской Федерации, за исключением
                случаев, предусмотренных п.п. 5.2. и 7.2. настоящей Политики
                Конфиденциальности.
              </p>
              ...
              <p>
                ...
                сайта Вагон Трейд, несет лицо, предоставившее такую информацию.
              </p>

              <p>
                7.5. Пользователь соглашается, что информация, предоставленная
                ему как часть сайта Вагон Трейд, может являться объектом
                интеллектуальной собственности, права на который защищены и
                принадлежат другим Пользователям, партнерам или рекламодателям,
                которые размещают такую информацию на сайте Вагон Трейд. <br />
              ...
              <p>
                ...
                находящихся в свободном публичном доступе на сайте Вагон Трейд)
                допускается их распространение при условии, что будет дана
                ссылка на Вагон Трейд.
              </p>

              <p>
                7.7. Администрация не несет ответственности перед Пользователем
                за любой убыток или ущерб, понесенный Пользователем в результате
                удаления, сбоя или невозможности сохранения какого-либо
                Содержания и иных коммуникационных данных, содержащихся на сайте
                Вагон Трейд или передаваемых через него.
              </p>
              ...
              <p>
                ...
                информацию, размещенную пользователем на сайте Вагон Трейд,
              ...
              <p>
                ...
                ее размещения на сайте Вагон Трейд, если иное не предусмотрено
              ...
              <p>
                ...
                странице по адресу http://vagontrade.ru/politika.html
              </p>

              <p>Обновлено: 27 Мая 2022 года</p>
              <p>г. Москва, </p>
            </div>
          </div>
        </div>
