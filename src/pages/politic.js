          ...
          <div className="col-12 m-col-12 xs-col-4">
            <div className="layout bl br middle-border-12">
              <p>
                ...
                информации, которую сайт <strong>ВагонТрейд</strong>, (далее –
                ВагонТрейд) расположенный на доменном имени{" "}
              ...
              <p>
                ...
                <strong>ВагонТрейд</strong>, которые организуют и (или)
              ...
              <p>
                1.1.5. «Сайт <strong> ВагонТрейд</strong>» - это совокупность
              ...
              <p>
                ...
                ВагонТрейд, а также другие временные страницы, внизу который
                указана контактная информация Администрации
              </p>

              <p>
                1.1.5. «Пользователь сайта <strong>ВагонТрейд</strong> » (далее
                Пользователь) – лицо, имеющее доступ к сайту{" "}
                <strong>ВагонТрейд</strong>, посредством сети Интернет и
                использующее информацию, материалы и продукты сайта{" "}
                <strong>ВагонТрейд</strong>.
              </p>
              ...
              <p>
                ...
                сети, через который Пользователь получает доступ на ВагонТрейд.
              </p>

              <h2>2. Общие положения</h2>
              <p>
                2.1. Использование сайта ВагонТрейд Пользователем означает
              ...
              <p>
                ...
                Пользователь должен прекратить использование сайта ВагонТрейд .
              </p>

              <p>
                2.3. Настоящая Политика конфиденциальности применяется к сайту
                ВагонТрейд. ВагонТрейд не контролирует и не несет
                ответственность за сайты третьих лиц, на которые Пользователь
                может перейти по ссылкам, доступным на сайте ВагонТрейд.
              </p>
              ...
              <p>
                ...
                регистрации на сайте ВагонТрейд или при подписке на
              ...
              <p>
                ...
                Пользователем путём заполнения форм на сайте ВагонТрейд и
              ...
              <p>
                3.3. ВагонТрейд защищает Данные, которые автоматически
              ...
              <p>
                3.3.2. ВагонТрейд осуществляет сбор статистики об IP-адресах
              ...
              <p>
                ...
                ВагонТрейд, если Пользователь дал согласие на создание учетной
                записи.
                <br />
              ...
              <p>
                ...
                находящихся в свободном публичном доступе на сайте ВагонТрейд)
                допускается их распространение при условии, что будет дана
                ссылка на ВагонТрейд.
              </p>
              ...
              <p>
                ...
                ВагонТрейд или передаваемых через него.
              </p>
              ...
              <p>
                ...
                информацию, размещенную пользователем на сайте ВагонТрейд,
              ...
              <p>
                ...
                ее размещения на сайте ВагонТрейд, если иное не предусмотрено
