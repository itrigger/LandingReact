    ...
    return (
        <div className="yellow_w_header">
            <div className="promo__icons">
                ...
                <div className="panel">
                    <b>В наличии на сегодня:</b>
                    <div>Колесные пары - 156</div>
                    <div>Боковые рамы - 96</div>
                    <div>Надрессорные балки - 85</div>
                </div>
            </div>
            <div className="in">
               ...
               <header className="header | d_f jc_sb ai_c col-10 xs-col-4">
                ...
                <div className="promo | col-10 xs-col-4">
                    <div className="promo__text | col-6 xs-col-4 d_f fd_c jc_c">
                        <h1>Покупка и продажа вагонов. Аренда. Запасные части.</h1>
                        <div className="promo__desc">
                            <p>Купить, арендовать или продать железнодорожные вагоны и запасные части становится проще, потому что мы создаем сервис для быстрого и легкого поиска. А пока идёт работа над созданием сайта, вы можете задать любой вопрос специалисту.</p>
                        </div>
                    </div>
                    <div className="col-1 xs-col-0" />
